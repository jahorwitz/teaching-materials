...
class Note extends React.Component {
    ...
    saveNote = () => {
        this.props.onSaveClicked(this.state.editTitle, this.state.editBody);
        this.toggleEditMode();
    }
                    ...
                    <div className="card-body">
                        {this.state.editMode && (
                            <div>
                                ...
                                <button className="btn btn-danger" onClick={this.toggleEditMode}>Cancel</button>
                            </div>
                        )}
                        {!this.state.editMode && (
                            <div>
                                ...
                                <button className="btn btn-danger" onClick={this.props.onDeleteClicked}>Delete</button>
                            </div>
                        )}
                    </div>
                </div>
